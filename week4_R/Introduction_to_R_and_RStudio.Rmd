---
title: "Introduction to R and RStudio COMPLETED"
...
```{r 2.2}
## don't run this
setwd("/home1/xylee/490_cluster/week4_R") 
# (ex:"/Users/nicoleblack/Desktop/qbio_490_nicole/week3_R")
...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/home1/xylee/490_cluster/week4_R")) 
```
...
```{r Exercise 3.4}
## add code here!
name <- "Xander" # string / character
age <- 19 # numeric / double
birthday <- c(01,01,2000) # vector / double
three_fav_colors <- c("red","blue","green") # vector / character
